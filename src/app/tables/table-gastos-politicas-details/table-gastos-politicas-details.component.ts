...
@Component({
  ...
  templateUrl: './table-gastos-politicas-details.component.html',
  styleUrls: ['./table-gastos-politicas-details.component.scss']
})

export class TableGastosPoliticasDetailsComponent {
